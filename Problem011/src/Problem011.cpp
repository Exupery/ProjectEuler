...
// Description : greatest product of four adjacent numbers
//============================================================================
...
int main(int argc, char* argv[]) {
	...
	int rows = 20;
	int cols = 20;
	int horiz = findHoriz(grid, rows, cols);
	int vert= findVert(grid, rows, cols);
	int diag = findDiagonal(grid, rows, cols);
	int greatest = findMax(horiz, vert, diag);
    std::cout << "The greatest product of four adjacent numbers is " << greatest << std::endl;
    return 0;
}
